...
#define STRING_CONFIG_H_AUTHOR "(Federico ,  Config 2)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.5, 88.5, 6350, 140 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 350, 350, 8, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 24, 10000 }
...
#define DEFAULT_RETRACT_ACCELERATION  1250//3000    // E acceleration for retracts
...
/**
 * Z probes require clearance when depploying, stowing, and moving between
